...
const Header = () => {
  return (
    <>
 <header className="text-primary body-font border py-1 sticky top-0 w-full bg-white z-[99] shadow-xl">
  <div className="container mx-auto flex flex-wrap  flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center gap-4">
      ...
      <Link className="mr-5 hover:text-third" to="/teams">Teams</Link>
    ...
    <div className="flex items-center gap-4 ">
      ...
      <Link to='/inquiry'>
      <button type="button" class="text-white bg-sec hover:bg-primary  font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2   ">Inquiry</button>
